...
export default class Map extends React.Component<props, state> {
  ...
  countEventsPerLocation() {
    const atLocation = this.props.events.filter(
      e =>
        e.latitude == this.state.selectedLocation.latitude &&
        e.longitude == this.state.selectedLocation.longitude
    );
            ...
            {selectedLocation && (
              ...
              >
                <div className="text-center">
                  ...
                  <a
                    onClick={() =>
                      this.setState({ viewLoginsPerLocation: true })
                    }
                  >
                    View events
                  </a>
    ...
    return (
      <div>
        <Helmet>
          <style>
            {
              ".col-sm-12,body{padding:0!important}.col-sm-12{width:100%!important}body{overflow-x:hidden}"
            }
          </style>
        </Helmet>
